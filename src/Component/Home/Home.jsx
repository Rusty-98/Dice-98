  ...
  return (
    <div className="bg-slate-700 w-full h-screen flex items-center justify-center">
      <div className="w-full md:w-4/5 h-3/4 flex items-center justify-between main">
        ...
        <div className="h-1/2 pr-6 md:w-4/5 w-full flex flex-col items-center md:items-end justify-end p-5 gap-6 write">
          <h1 className="text-white text-8xl md:text-9xl text-center md:text-left fon tracking-tighter">Dice Game</h1>
          <button
            onClick={togglePlay}
